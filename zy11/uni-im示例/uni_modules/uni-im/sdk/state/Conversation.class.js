    ...
    if (!conversation_id && !group_id) {
      ...
      if(conversationCount !== 0){
        ...
        if(normalConversationCount === 0){
          ...
          maxLastMsgCreateTime = this.loadMore?.lastConversation?.[loadMoreType]?.last_msg_create_time || false
          // console.log('maxLastMsgCreateTime：'+maxLastMsgCreateTime,'loadMoreType:'+loadMoreType)
